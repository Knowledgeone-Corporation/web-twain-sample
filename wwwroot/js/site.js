$(function () {
    $('#scanbtn').k1scanservice({
        ...
        version: "1.0.2" //This is optional. This will check that the version of the service is the same as whats expected by the installer.  You can update this when there is a new release
    });    
});
